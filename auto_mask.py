...
parser = argparse.ArgumentParser(
    prog="AutoMask", description="Generate mask, metadata, overlay for iamge"
)
parser.add_argument(
    "-i",
    "--input_image",
    type=str,
    default="sample_inputs/truck.jpg",
    help="input image to run",
)
parser.add_argument(
    "-o",
    "--output_dir",
...
parser.add_argument(
    "-m", "--model", type=str, default="model/sam_vit_h_4b8939.pth", help="model path"
)
parser.add_argument(
    "-t",
    "--model_type",
